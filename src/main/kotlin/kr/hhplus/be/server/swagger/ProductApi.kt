...
interface ProductApi {
    @Operation(summary = "상품조회 API", description = "상품아이디 이용 상품을 조회합니다.")
    ...
    @Operation(summary = "상위상품조회 API", description = "상위 상품을 조회합니다..")
    @ApiResponses(
        ApiResponse(
            responseCode = "200",
            description = "상위상품조회 성공",
            content = [
                Content(
                    array = ArraySchema(
                        schema = Schema(
    ...
    fun findRankProducts(): List<Product>
}